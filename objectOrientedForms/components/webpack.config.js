...
module.exports ={
    ...
    output:{
        ...
        // filename:'bundle.js',
        filename:'[name].js',//since we need two bundle files, so we cannot hard code the file name, just like special sequence that webpack will tag and replace with proper name. now two bundle files are generated, app.js and vendor.js
        publicPath:'./public'
    },
